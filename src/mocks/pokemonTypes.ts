export const pokemonTypes = {
  ...
  moves: [
    ...
    {
      name: 'jet-punch',
      url: 'https://pokeapi.co/api/v2/move/857/',
    },
    {
      name: 'triple-dive',
      url: 'https://pokeapi.co/api/v2/move/865/',
    },
    {
      name: 'aqua-step',
      url: 'https://pokeapi.co/api/v2/move/872/',
    },
    {
      name: 'hydro-steam',
    ...
    {
      name: 'aqua-cutter',
      url: 'https://pokeapi.co/api/v2/move/895/',
    },
  ],
  name: 'water',
  names: [
  ...
  sprites: {
    'generation-iii': {
      ...
      'ruby-saphire': {
        name_icon:
          'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/types/generation-iii/ruby-saphire/11.png',
      },
      xd: {
        name_icon:
          'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/types/generation-iii/xd/11.png',
      },
    },
    'generation-iv': {
      'diamond-pearl': {
        name_icon:
          'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/types/generation-iv/diamond-pearl/11.png',
      },
      'heartgold-soulsilver': {
        name_icon:
          'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/types/generation-iv/heartgold-soulsilver/11.png',
      },
      platinum: {
        name_icon:
    ...
    'generation-v': {
      'black-2-white-2': {
        name_icon:
          'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/types/generation-v/black-2-white-2/11.png',
      },
      'black-white': {
        name_icon:
          'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/types/generation-v/black-white/11.png',
      },
    },
    'generation-vi': {
    ...
    'generation-vii': {
      ...
      'sun-moon': {
        name_icon:
          'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/types/generation-vii/sun-moon/11.png',
      },
      'ultra-sun-ultra-moon': {
        name_icon:
          'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/types/generation-vii/ultra-sun-ultra-moon/11.png',
      },
    },
    'generation-viii': {
      ...
      'legends-arceus': {
        name_icon:
          'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/types/generation-viii/legends-arceus/11.png',
      },
      'sword-shield': {
        name_icon:
